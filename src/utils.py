...
def get_args():
    ...
    parser.add_argument('--log_path', type=str, default='./logs/Imm_TAN', help='Path to save the logs')
    parser.add_argument('--model_save_path', type=str, default='./Models/Imm_TAN', help='Path to save the model')
    parser.add_argument('--device', type=str, default='cuda:0', help='whether use gpu')

    parser.add_argument('--model', type=str, default='TAN', help='which model to train')
    ...
    parser.add_argument('--nhead', type=int, default=8, help='MTSa attn heads')
    parser.add_argument('--num_layers', type=int, default=2, help='number of MTsa layers')
